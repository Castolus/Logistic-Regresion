...
scaler = MaxAbsScaler()
house_data_hip3[["price","sqft_living","sqft_above","sqft_basement",'sqft_lot','condition','yr_built','yr_renovated']] = scaler.fit_transform(house_data_hipot3[["price","sqft_living","sqft_above","sqft_basement",'sqft_lot','condition','yr_built','yr_renovated']] )
...
acc3=regresion_lineal.score(x_hip3_train,y_hip3_train)
print('Accuracy 1= '+str(acc))
print('Accuracy 2= '+str(acc2))
